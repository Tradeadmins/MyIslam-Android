...
public class SharedAllahName {
    SharedPreferences pref;
    Editor edit;

    public static final String allahName = "allahName";

    public SharedAllahName(Context c) {
    ...
    public ArrayList<NameOfAllahModel> getDataArray(){
        ...
        data = new Gson().fromJson(pref.getString(allahName,""), listType);
